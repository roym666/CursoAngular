...
using Northwind.Store.UI.Intranet.Services;
...
namespace Northwind.Store.UI.Intranet
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("SeguridadConnection")));
